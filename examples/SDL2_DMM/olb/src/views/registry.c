...
static const dmm_view_def_t k_dmm_views[] = {
    ...
    {
        .id           = "dmm-compact",
        .display_name = "DMM compact — 320x170 stacked readout",
        .description  = "Small-panel readout: mode label, big centered VFD value+unit, AUTO/rate/OL badges.",
        .run          = view_dmm_compact_run,
    },
};

static const dmm_view_def_t *k_dmm_view_ptrs[] = {
    &k_dmm_views[0], &k_dmm_views[1], &k_dmm_views[2],
};
